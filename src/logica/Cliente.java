...
public class Cliente implements Serializable {
    ...
    public Cliente(int id, int num_cliente, String nombre_perro, String raza, String color, boolean alergico, boolean atención_especial, String nombre_duenio, String celular_duenio, String observaciones) {
        this.id = id;
